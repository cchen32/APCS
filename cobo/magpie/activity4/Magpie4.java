...
public class Magpie4
{
	...
	//If you ask I _ you are ..., the response you get eliminates the trailing part
	//To fix this, you could create another restOfStatement var (w a different name), and add that to the end
